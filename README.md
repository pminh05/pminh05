...
* 🎯 **Current Focus:** Building AI/ML solutions with **Python**, **LLM Fine-tuning**, **GraphRAG**, and **Prompt Engineering**.
* 📚 **Learning Next:** Advanced **Cloud Solutions**, **DevOps**, and **Scalable System Design**.
* 🏫 **Background:** VinUni AICB Cohort 3 - Track 3 Student | Active participant in AI product development hackathons.
* 🤝 **Collaborations:** Open to discussions on **AI/ML**, **RAG Systems**, **LLM Applications**, and **Data Engineering**.
...
### 🎓 Key Projects & Learning Areas

**AI/ML & LLM:**
- 🦜 **Prompt Engineering & Tool Calling** - Advanced LLM interaction patterns
- 🔄 **LoRA Fine-tuning** - Parameter-efficient model adaptation
- 📊 **GraphRAG & Vector Stores** - Data foundation and retrieval-augmented generation
- 🤖 **Agent Arena** - Multi-agent system competitions
- 🏆 **AI Product Hackathons** - VLSP K3 AI Batch03 Mini Hackathon

**Data & Algorithms:**
- 🧮 Algorithm Practice (C++, Java) - Competitive programming fundamentals
- 📈 Auto Grading Systems - Python-based evaluation automation
